        ...
        super(
          ...
          builder: (FormFieldState<String> field) {
            ...
            if (decoration != null) {
              ...
              final TextStyle labelStyleError = labelStyle ?? AppTextStyle.s16w400cBlack;
              final TextStyle hintStyleError = hintStyle ?? AppTextStyle.s16w400cBlack;
              effectiveDecoration = InputDecoration(
                ...
                hintStyle: state._checkLabelError
                    ...
                    : hintStyle ?? AppTextStyle.s16w400cBlack.copyWith(color: theme.colors.gray700),
                ...
                prefixIconConstraints: const BoxConstraints(
                    maxHeight: Dimension.padding36, minHeight: Dimension.padding28),
                prefix: prefixWidget,
                    ...
                    ? Text.rich(
                        TextSpan(
                          ...
                          style: state._checkLabelError
                              ...
                              : labelStyle ??
                                  AppTextStyle.s16w400cBlack.copyWith(color: theme.colors.gray700),
                          children: <TextSpan>[
                            isRequired
                                ? TextSpan(
                                    text: ' *',
                                    style: labelStyleError.copyWith(color: theme.colors.red),
                                  )
                                : const TextSpan(),
                          ],
                        ),
            ...
            final double customCursorHeight = style != null ? style.fontSize! : 16;
            return TextField(
              ...
              textInputAction: textInputAction,
              style: style ?? AppTextStyle.s16w400cBlack,
              textAlign: textAlign,
              textAlignVertical: textAlignVertical,
              textDirection: textDirection,
...
class TextsFieldState extends FormFieldState<String> {
  ...
  Widget build(BuildContext context) {
    ...
    final Color borderColor = widget.borderColor ?? widget.theme.colors.border;
    final Color focusBorderColor = widget.borderColor ?? widget.theme.colors.primary;
    _checkLabelError = checkLabelError();
    final titleStyle = widget.labelStyle ?? AppTextStyle.s12.copyWith(color: theme.colors.gray700);
    return Visibility(
          ...
          children: [
                      ...
                      Expanded(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            super.build(context),
                            Visibility(
                              visible: widget.maxLines != null && widget.maxLines! > 1,
                              child: Container(
            ...
            checkError()
                ? Container(
                    ...
                    child: Text(
                      errorText!,
                      style: AppTextStyle.s14w400cBlack.copyWith(color: theme.colors.error),
                      maxLines: 3,
                      overflow: TextOverflow.ellipsis,
                    ),
                  )
