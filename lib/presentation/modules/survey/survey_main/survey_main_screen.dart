...
import 'package:home_care/presentation/modules/survey/survey_main/cubit/survey_main_cubit.dart';
...
part 'components/survey_main_view.dart';

class SurveyMainScreen extends StatelessWidget {
  const SurveyMainScreen({super.key});

  @override
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (_) => SurveyMainCubit(),
      child: const SurveyMainView(),
    );
  }
}
